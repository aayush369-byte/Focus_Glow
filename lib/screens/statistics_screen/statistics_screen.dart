...
//this is the statistics screen where users can view their focus statistics and progress over time. It includes various charts and summary cards to provide insights into their focus habits.
// this is screen page
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(flex: 6, child: CategoryChartCard()),
                        SizedBox(width: 10),
                        Expanded(flex: 4, child: MonthlyFocusCard()),
                      ],
                    ),
                  ],
                ),
